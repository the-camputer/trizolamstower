...
class TrizolamGrammarRules
{
  public:
    ...
    static inline Rule TravelCommand = {"travel-command",
                                        {
                                            {
    ...
    static inline Rule MovementCommand = {"movement-command",
                                          {
                                              {
    ...
    static inline Rule SceneObject = {"scene-object",
                                      {
                                          {
    ...
    static inline Rule MetaCommand = {"meta-command",
                                      {
                                          {
