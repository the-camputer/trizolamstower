...
class TrizolamGrammarRules {
    public:
        ...
        static inline Rule PersonalCommand =
        {
            "personal-command",
            {
        ...
        static inline Rule InsightCommand =
        {
            "insight-command",
            {
                { { "perception-command", SYMBOL_TYPE::NONTERMINAL }, { "optional-article", SYMBOL_TYPE::NONTERMINAL }, { "scene-object", SYMBOL_TYPE::NONTERMINAL} },
                { { "perception-command", SYMBOL_TYPE::NONTERMINAL } }
            }
        };

        static inline Rule PerceptionCommand =
        {
            "perception-command",
            {
        ...
        static inline Rule InteractableObject =
        {
            "interactable-object",
            {
        ...
        static inline Rule PlayerCharacter =
        {
            "player-character",
            {
        ...
        static inline Rule SaveStateCommand =
        {
            "save-state-command",
            {
        ...
        static inline Rule SaveCommand =
        {
            "save-command",
            {
        ...
        static inline Rule LoadCommand =
        {
            "load-command",
            {
        ...
        static inline Rule ResetCommand =
        {
            "reset-command",
            {
        ...
        static inline Rule InventoryCommand =
        {
            "inventory-command",
            {
                { { "take-command", SYMBOL_TYPE::NONTERMINAL }, { "optional-article", SYMBOL_TYPE::NONTERMINAL }, { "inventory-object", SYMBOL_TYPE::NONTERMINAL } },
                { { "drop-command", SYMBOL_TYPE::NONTERMINAL }, { "optional-article", SYMBOL_TYPE::NONTERMINAL }, { "inventory-object", SYMBOL_TYPE::NONTERMINAL } },
                { { "place-command", SYMBOL_TYPE::NONTERMINAL }, { "optional-article", SYMBOL_TYPE::NONTERMINAL }, { "inventory-object", SYMBOL_TYPE::NONTERMINAL }, { "preposition", SYMBOL_TYPE::NONTERMINAL }, { "optional-article", SYMBOL_TYPE::NONTERMINAL }, { "interactable-object", SYMBOL_TYPE::NONTERMINAL } }
            }
        };

        static inline Rule TakeCommand =
        {
            "take-command",
            {
        ...
        static inline Rule DropCommand =
        {
            "drop-command",
            {
        ...
        static inline Rule PlaceCommand =
        {
            "place-command",
            {
        ...
        static inline Rule Preposition =
        {
            "preposition",
            {
        ...
        static inline Rule InteractionCommand =
        {
            "interaction-command",
            {
                // This will be filled in dynamically based on scene and configuration 
